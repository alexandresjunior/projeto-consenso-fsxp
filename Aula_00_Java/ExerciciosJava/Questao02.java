...
public class Questao02 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Digite as horas  totais trabalhadas pelo funcionario: ");
        horasTrabalhadas = entrada.nextInt();

        System.out.println("Digite o ganho por hora do usuario: ");
        salarioHora = entrada.nextDouble();

        salarioTotal = salarioHora * horasTrabalhadas;

        System.out.printf("\nNÚMERO = %d\nSALÁRIO = R$ %.2f",numero,salarioTotal);
